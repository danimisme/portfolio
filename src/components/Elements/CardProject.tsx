  ...
  return (
    ...
    >
      <div className="rounded-md shadow-md overflow-hidden relative">
        ...
        />
        <button className="font-semibold border-[3px] border-primary bg-black/20 py-2 px-5 rounded-lg text-primary absolute top-1/2 left-1/2 -translate-x-1/2 group-hover:-translate-y-1/2 opacity-0 group-hover:opacity-100 transition duration-1000 hover:bg-white hover:bg-opacity-50">
          View
        </button>
      </div>
